...
export default function SimulationShowcase() {
  ...
  return (
    ...
    <div className="relative min-h-screen text-[15px] md:text-[16px] text-foreground">
          <section className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between gap-3 pt-5 pb-5">
      ...
      <main className="mx-auto max-w-6xl px-4 pb-16">
        ...
        <section className="mt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <Link
              href="/cobalt-oxides"
              className="block rounded-2xl border bg-card text-card-foreground shadow-sm overflow-hidden transition hover:shadow-md"
            >
              ...
              <div className="p-5">
                ...
                <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                  Data-driven analysis of DFT formation energies as a function of Co/O ratio,
                  hydrogen content, and chemical reservoir conditions.
                </p>
            ...
            <Link
              href="/smoothing-demo"
              className="block rounded-2xl border bg-card text-card-foreground shadow-sm p-5 transition hover:shadow-md"
            >
              <h3 className="text-xl font-semibold">
              ...
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                Explore how smoothing parameters affect noisy spectroscopic data.
              </p>
